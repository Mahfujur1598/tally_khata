...
class MediaQueryUtils {
  ...
  static double get bottomPadding =>
      _mediaQueryData.padding.bottom + _mediaQueryData.viewInsets.bottom;
  static double get safeAreaHeight =>
      _mediaQueryData.size.height - _mediaQueryData.padding.top - _mediaQueryData.padding.bottom;
